...
<input type="text" name="min_price" class="price_range" placeholder="Min R" value="<?= $min_price;?>"> To
<input type="text" name="max_price" class="price_range" placeholder="Max R" value="<?= $max_price;?>"><br><br>
